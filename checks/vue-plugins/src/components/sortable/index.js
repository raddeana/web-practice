...
Sortable.prototype = /** @lends Sortable.prototype */ {
	...
	_onDrop: function (/**Event*/evt) {
		...
		console.log('i do a drop2', dragEl);
		if (evt) {
			if (moved) {
				evt.cancelable && evt.preventDefault();
			...
			console.log('i do a drop3', dragEl);
			if (dragEl) {
				if (this.nativeDraggable) {
				...
				console.log('i do a drop4', dragEl);
				// Drag stop event
				_dispatchEvent({
					sortable: this,
					name: 'unchoose',
		...
		console.log('i do a drop5', dragEl);
		this._nulling();
	},
